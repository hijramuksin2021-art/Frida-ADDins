...
const AGENT_SYSTEM_PROMPT_BASE = [
  ...
  "- 'buat tabel bergaris penuh/grid', 'beri garis di semua sel', 'ubah border tabel', 'rapikan lebar kolom' (tabel SUDAH ADA) -> format_table dengan borders='all' atau autoFit=true. JANGAN pakai create_table untuk mengubah tabel yang sudah ada.",
